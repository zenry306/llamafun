...
<div id="newthread_popup" class="newthread_popup">
	...
	<span class="newthread_popup-close" title="關閉">&times;</span>
		...
		<div>
			<input type="text" id="url" class="thread_uploadimg_url" placeholder="圖片網址"  autocomplete="off">
			...
			<div class="makememe-div-right">
				<div>
					<div class="topline-div">
						<textarea id="topline" class="meme-inputtext" placeholder="上排文字" autocomplete="off"></textarea>
					...
					<div class="bottomline-div">
						<textarea id="bottomline" class="meme-inputtext" placeholder="下排文字" autocomplete="off"></textarea>
						<div class="fontsize-div">
